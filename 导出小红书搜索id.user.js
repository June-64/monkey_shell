...
(function () {
  ...
  toggleInputButton.innerText = "<";
  toggleInputButton.style.marginLeft = "5px";
  inputBox.style.display = "none";
  buttonContainer.appendChild(toggleInputButton);
  ...
  toggleInputButton.addEventListener("click", function () {
    inputBox.style.display =
      inputBox.style.display === "none" ? "block" : "none";
    toggleInputButton.innerText = inputBox.style.display === "none" ? "<" : ">";
  });
  ...
  function newXHR() {
    ...
    xhr.addEventListener("readystatechange", function () {
      if (
        xhr.readyState === 4 &&
        xhr.status === 200 &&
        xhr.responseURL.includes("/api/sns/web/v1/search/notes")
      ) {
